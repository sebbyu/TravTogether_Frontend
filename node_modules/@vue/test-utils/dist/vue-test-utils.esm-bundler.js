...
/**
 * @vue/test-utils v2.0.0-beta.12
 * (c) 2020 Lachlan Miller
 * Released under the MIT License
 */

import * as vue from 'vue';
import { nextTick, getCurrentInstance, defineComponent, h, transformVNodeArgs, Transition, TransitionGroup, reactive, createApp } from 'vue';
...
function createDOMEvent(eventString, options) {
    ...
    var eventParams = { eventType: eventType, modifiers: modifiers, options: options };
...
var VueWrapper = /** @class */ (function () {
    ...
    VueWrapper.prototype.emitted = function (eventName) {
        if (eventName) {
            var emitted = this.vm['__emitted'][eventName];
            return emitted;
        }
    ...
    return {
        beforeCreate: function () {
            ...
            getCurrentInstance().emit = function (event) {
                ...
                var consoleWarnSave = console.warn;
                console.warn = function (msg) {
                    ...
                    if (msg.includes('[Vue warn]: Component emitted event')) {
                        ...
                        consoleWarnSave.apply(void 0, __spreadArrays([msg], rest));
                    }
                };
...
var createStub = function (_a) {
    ...
    return defineComponent({ name: name || anonName, render: render, props: props });
};
    ...
    if (isFunctionalComponent(originalComponent)) {
        ...
        component = defineComponent({
            setup: function (_, _a) {
                ...
                return function () {
                    return h(function (props, ctx) {
                        return originalComponent(props, __assign(__assign(__assign({}, ctx), attrs), { emit: emit, slots: slots }));
                    });
                };
            }
        });
